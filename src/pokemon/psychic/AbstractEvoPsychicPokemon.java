...
/**
 * Abstract class that represents a generic evolved psychic Pokémon. This class receives all the methods implemented in
 * AbstractPsychicPokemon and implements a method to return the pre-evolution of it.
 *
 * @author Romina Rodríguez
 */
public abstract class AbstractEvoPsychicPokemon extends AbstractPsychicPokemon implements IEvoPokemon {
