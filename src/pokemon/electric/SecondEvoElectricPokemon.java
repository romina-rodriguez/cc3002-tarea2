...
public class SecondEvoElectricPokemon extends AbstractElectricPokemon implements ISecondEvoPokemon {

    private int preEvolution;

    /**
     * Creates a new Second Evolution Electric Pokémon.
     *
     ...
     */
    protected SecondEvoElectricPokemon(String name, int number, int hp, ArrayList<IAttack> attackList, ArrayList<IEnergy> energyList,
                                       int preEvolution) {
